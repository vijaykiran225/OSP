...
$s=$_SESSION['name']."log";
$res=mysql_query("select title,artist,count(*) from $s where title is not null group by title,artist") or die ("error 3");
...
$myPicture = new pImage(1366,768,NULL);
...
$progressOptions = array("Width"=>150,"Height"=>25, "R"=>209, "G"=>125, "B"=>27, "Surrounding"=>20, "BoxBorderR"=>0, "BoxBorderG"=>0, "BoxBorderB"=>0,"BoxBackR"=>255, "BoxBackG"=>255, "BoxBackB"=>255, "Orientation"=>ORIENTATION_HORIZONTAL, "ShowLabel"=>TRUE, "LabelPos"=>LABEL_POS_RIGHT);
...
{
$percent=($n['count(*)']/$num)*100;
$myPicture->drawText($y,$x+20,$n['title']." by ".$n['artist'],array("FontSize"=>20));
$myPicture->drawProgress(500,$x,$percent,$progressOptions);
$x=$x+30;
